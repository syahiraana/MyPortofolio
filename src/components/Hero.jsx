// src/components/Hero.js - FIXED VERSION
'use client'
...
export default function Hero() {
  ...
  return (
    <section id="home" className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 relative overflow-hidden pt-24 md:pt-28 lg:pt-32">
      ...
      {/* Fixed Container */}
      <div className="hero-grid min-h-[calc(100vh-96px)] md:min-h-[calc(100vh-112px)] lg:min-h-[calc(100vh-128px)] px-4 sm:px-6 lg:px-8">
        
        {/* Mobile Layout: Image First */}
        <div className="hero-image-container w-full lg:hidden flex justify-center mb-6 pt-8">
          <div className="relative w-80 h-80 sm:w-96 sm:h-96 mx-auto">
            <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-full overflow-hidden shadow-2xl border-8 border-white relative mx-auto">
  ...
  {/* Mobile Floating Icons - More spacing */}
              <div className="absolute -top-2 right-16 bg-gradient-to-br from-slate-700 to-slate-900 p-3 rounded-full shadow-lg animate-float">
                <Code size={18} className="text-white" />
              </div>
              <div className="absolute top-16 -right-2 bg-gradient-to-br from-slate-800 to-slate-900 p-3 rounded-full shadow-lg animate-float" style={{animationDelay: '0.5s'}}>
                <Sparkles size={18} className="text-white" />
              </div>
              <div className="absolute -bottom-2 left-16 bg-gradient-to-br from-slate-700 to-slate-900 p-3 rounded-full shadow-lg animate-float" style={{animationDelay: '1s'}}>
                <FileText size={18} className="text-white" />
              </div>
              <div className="absolute bottom-16 -left-2 bg-gradient-to-br from-slate-800 to-slate-900 p-3 rounded-full shadow-lg animate-float" style={{animationDelay: '1.5s'}}>
        ...
        <div className="hero-content hero-text-container text-center lg:text-left relative z-10">
        ...
        <div className="hero-image-container hidden lg:flex justify-center relative pt-8">
          <div className="relative w-96 h-96 xl:w-[450px] xl:h-[450px] 2xl:w-[500px] 2xl:h-[500px]">
            <div 
              className="w-80 h-80 xl:w-96 xl:h-96 2xl:w-[450px] 2xl:h-[450px] rounded-full overflow-hidden shadow-2xl border-8 border-white relative mx-auto"
              style={{
            ...
            {/* Desktop Floating Icons - FIXED positioning */}
            <div className="absolute top-8 right-4 bg-gradient-to-br from-slate-700 to-slate-900 p-4 rounded-full shadow-lg animate-float">
              <Code size={22} className="text-white" />
            </div>
            <div className="absolute top-20 right-2 bg-gradient-to-br from-slate-800 to-slate-900 p-4 rounded-full shadow-lg animate-float" style={{animationDelay: '0.5s'}}>
              <Sparkles size={22} className="text-white" />
            </div>
            <div className="absolute bottom-8 left-4 bg-gradient-to-br from-slate-700 to-slate-900 p-4 rounded-full shadow-lg animate-float" style={{animationDelay: '1s'}}>
              <FileText size={22} className="text-white" />
            </div>
            <div className="absolute bottom-20 left-2 bg-gradient-to-br from-slate-800 to-slate-900 p-4 rounded-full shadow-lg animate-float" style={{animationDelay: '1.5s'}}>
